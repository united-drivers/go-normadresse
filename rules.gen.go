...
var rules = []rule{
	...
	{1.000000, " de la fontaine${1}", " DE LA FONTAINE( PROLONGEE|$)"},
	...
	{4.000000, "PT", "PETITS"},
	{5.000000, "AIRE", "AIRES "},
	{5.000000, "ANCI ${2}", "ANCIEN(NES|NE|S|) (CHEMIN|CHEMINS|ROUTE|ROUTES)"},
	...
	{5.000000, "CHEM ${1}", "CHEMIN( VICINAL|S VICINAUX|EMENT(S|))"},
	...
	{5.000000, "GRAN ${1}${2}", "GRAND(E|ES|) (BOULEVARD|ENSEMBLE|RUE)(S|)"},
	...
	{5.000000, "PETI ${1}${2}", "PETIT(E|ES|) (CHEMIN|ALLEE|IMPASSE|ROUTE|RUE)(S|)"},
